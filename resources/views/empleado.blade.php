    ...
    <div class="moduloRegistrarEmpleado">
        ...
        <!-- ============Modulo Area ============ -->   
            <div class="moduloArea ocultar">
                ...
                <div class="row contenedorTablaArea mt-2">                        
        ...
        <!-- ============Datos area ============ -->   
            ...
            <div class="moduloEmpresa ocultar">
                ...
                <div class="row contenedorTablaEmpresa mt-3">                        
                        <div class="table-responsive">
        ...
        <div class="contenedorDatos">
            <div class="row  contenedorBoton w-100 mt-5 px-5">
                <div class="col-12 col-md-4 col-lg-2 mb-1">
                    <button id="btnActivo" class="botonBaseUno w-100">Activos</button>
                </div>
                <div class="col-12 col-md-4 col-lg-2 mb-1">
            ...
            <!-- ============ Tabla empleado ============ -->
                    <div class="col-12 tblEmpleado">
                        <div class="table-responsive ">
                            <table id="tblEmpleado" class="tablaBaseUno">
                                <thead>
                                    <tr>
                                        <th class="px-5">Codigo</th>
                                        <th class="px-5">Nombre</th>
                                        <th class="px-5">Apellido paterno</th>
                                        <th class="px-5">Apellido materno</th>
                                        <th class="px-5">Correo</th>
                                        <th class="px-5">Codigo Area</th>
                                        <th class="px-5">Area</th>
                                        <th class="px-5">Codigo Empresa</th>
            ...
            <!-- ============ Tabla empleado eliminado============ -->
                    <div class="col-12 tblEmpleadoEliminado">
                        <div class="table-responsive ">
                            <h1 class="mx-5 mt-3">Empleados eliminados</h1>
                            <table id="tblEmpleadoEliminado" class="tablaBaseUno">
                                <thead>
                                    <tr>
                                        <th class="px-5">Codigo</th>
                                        <th class="px-5">Nombre</th>
